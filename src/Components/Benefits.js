        ...
        {/* <div className="space-y-6 sm:pl-10">
          ...
          <div className="flex flex-col sm:flex-row">
            ...
            <div>
              ...
              <p className="text-sm text-gray-900">
                Our School Management System (SMS) simplifies the management of
                library resources, including book issuance, returns, and
                cataloging, specifically tailored for educational institutions.
              </p>
            </div>
          </div>
          <div className="flex flex-col sm:flex-row">
            ...
            <div>
              ...
              <p className="text-sm text-gray-900">
                Our School Management System (SMS) facilitates seamless
                communication between stakeholders, including parents, teachers,
                and administrators, through instant messaging and notifications
              </p>
            </div>
          </div>
          <div className="flex flex-col sm:flex-row">
            ...
            <div>
              ...
              <p className="text-sm text-gray-900">
                Tailors the best School Management Software to meet the specific
                needs of your institution with customizable modules and features
                for different educational environments.
              </p>
            </div>
          </div>
        </div> */}
