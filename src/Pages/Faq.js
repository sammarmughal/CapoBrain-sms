...
const FAQs = () => {
    ...
    const data = [
        ...
        {
            heading: "How can I manage student admissions with CapoBrain's Student Information System (SIS)?",
            paragraph:
          ...
          {
            heading: "How does the Leave Request feature work for staff and students in CapoBrain?",
            paragraph:
          ...
          {
            heading: "Can I manage fee payments and scholarships in CapoBrain's School Fee Management System?",
            paragraph:
          ...
          {
            heading: "How does the Inventory List feature help in managing school supplies?",
            paragraph:
          ...
          {
            heading: "What types of reports can I generate with CapoBrain's reporting features?",
            paragraph:
          ...
          {
            heading: "How can I manage user roles and permissions in CapoBrain's User Management module?",
            paragraph:
          ...
          {
            heading: "Can I customize class schedules, subjects, and school timings in CapoBrain?",
            paragraph:
          ...
          {
            heading: "Are there any hidden charges or additional fees for using CapoBrain?",
            paragraph:
        ...
        <div className="relative z-10 max-w-screen-xl mx-auto px-4 py-28 md:px-8">
          <div className="space-y-5 max-w-8xl mx-auto text-center">
            <h1 className="text-4xl lg:text-6xl font-[1000] text-white" style={{ fontFamily: 'Grotesk-Medium, Verdana, sans-serif' }}>
               Freqently Asked Questions </h1>
            <p className="max-w-2xl mx-auto text-gray-200">
            Find answers to common questions about our School Management System (SMS). Learn how our platform can simplify your school’s administrative tasks, improve student data management, and enhance communication between parents, teachers, and administrators.
            </p>
          </div>
        </div>
        <div
