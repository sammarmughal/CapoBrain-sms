...
export default function Blogcat() {
  ...
  const metaDescription = posts.content
    ...
    : "Read insightful articles on Capobrain.";
  const metaTitle = posts.title
    ? posts.title.slice(0, 50)
    : "Capobrain School Management Software";
  ...
  return (
    <>
      ...
      {loading ? (
        <div className="relative z-10 max-w-screen-xl mx-auto px-4 py-28 md:px-8 cb-container">
          <div className="space-y-5 max-w-8xl mx-auto text-center">
            <div className="animate-pulse">
              <div className="h-6 bg-gray-300 rounded w-2/4 mb-4"></div>
              <div className="block h-2 mb-2 font-sans text-base antialiased font-light leading-relaxed bg-gray-300 rounded-full text-inherit w-[85%]">
                &nbsp;
              </div>
              <div className="block h-2 mb-2 font-sans text-base antialiased font-light leading-relaxed bg-gray-300 rounded-full text-inherit w-[85%]">
                &nbsp;
          ...
          <div className="space-y-5 max-w-8xl mt-10 mx-auto text-center">
            <div className="animate-pulse">
              <div className="h-6 bg-gray-300 rounded w-2/4 mb-4"></div>
              <div className="block h-2 mb-2 font-sans text-base antialiased font-light leading-relaxed bg-gray-300 rounded-full text-inherit w-[85%]">
                &nbsp;
